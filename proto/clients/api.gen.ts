...
export const WebRPCSchemaHash = "2955a71ff75a42329946595a7ad63c1eb01b429c"
...
export interface API {
  ...
  createOrganizationMember(args: CreateOrganizationMemberArgs, headers?: object): Promise<CreateOrganizationMemberReturn>
  getOrganizationMember(args: GetOrganizationMemberArgs, headers?: object): Promise<GetOrganizationMemberReturn>
  getAllOrganizationMembers(args: GetAllOrganizationMembersArgs, headers?: object): Promise<GetAllOrganizationMembersReturn>
  updateOrganizationMember(args: UpdateOrganizationMemberArgs, headers?: object): Promise<UpdateOrganizationMemberReturn>
  deleteOrganizationMember(args: DeleteOrganizationMemberArgs, headers?: object): Promise<DeleteOrganizationMemberReturn>
  createSalaryPayments(args: CreateSalaryPaymentsArgs, headers?: object): Promise<CreateSalaryPaymentsReturn>
  getSalaryPaymentByTxnHash(args: GetSalaryPaymentByTxnHashArgs, headers?: object): Promise<GetSalaryPaymentByTxnHashReturn>
  getOrgMemberSalaryPaymentsHistory(args: GetOrgMemberSalaryPaymentsHistoryArgs, headers?: object): Promise<GetOrgMemberSalaryPaymentsHistoryReturn>
  getMemberOverallSalaryHistory(args: GetMemberOverallSalaryHistoryArgs, headers?: object): Promise<GetMemberOverallSalaryHistoryReturn>
}
...
export interface CreateSalaryPaymentsArgs {
  organizationID: string
  memberAddressesAmountMap: {[key: string]: number}
  transactionHash: string
  tokenType: TokenType
}

export interface CreateSalaryPaymentsReturn {
  status: boolean
  payments: Array<Payment>  
}
export interface GetSalaryPaymentByTxnHashArgs {
  transactionHash: string
}

export interface GetSalaryPaymentByTxnHashReturn {
  payment: Payment  
}
export interface GetOrgMemberSalaryPaymentsHistoryArgs {
  organizationID: string
  memberAddress: string
}

export interface GetOrgMemberSalaryPaymentsHistoryReturn {
  payments: Array<Payment>  
}
export interface GetMemberOverallSalaryHistoryArgs {
  memberAddress: string
}

export interface GetMemberOverallSalaryHistoryReturn {
  payments: Array<Payment>  
}
...
export class API implements API {
  ...
  getAllOrganizationMembers = (args: GetAllOrganizationMembersArgs, headers?: object): Promise<GetAllOrganizationMembersReturn> => {
    return this.fetch(
      ...
      return buildResponse(res).then(_data => {
        return {
          organizationMembers: <Array<OrganizationMember>>(_data.organizationMembers)
        }
      })
    })
  }
  ...
  getSalaryPaymentByTxnHash = (args: GetSalaryPaymentByTxnHashArgs, headers?: object): Promise<GetSalaryPaymentByTxnHashReturn> => {
    return this.fetch(
      this.url('GetSalaryPaymentByTxnHash'),
      createHTTPRequest(args, headers)).then((res) => {
      return buildResponse(res).then(_data => {
        return {
          payment: <Payment>(_data.payment)
        }
      })
    })
  }
  ...
  getOrgMemberSalaryPaymentsHistory = (args: GetOrgMemberSalaryPaymentsHistoryArgs, headers?: object): Promise<GetOrgMemberSalaryPaymentsHistoryReturn> => {
    return this.fetch(
      this.url('GetOrgMemberSalaryPaymentsHistory'),
      createHTTPRequest(args, headers)).then((res) => {
      return buildResponse(res).then(_data => {
        return {
          payments: <Array<Payment>>(_data.payments)
  ...
  getMemberOverallSalaryHistory = (args: GetMemberOverallSalaryHistoryArgs, headers?: object): Promise<GetMemberOverallSalaryHistoryReturn> => {
    return this.fetch(
      this.url('GetMemberOverallSalaryHistory'),
      createHTTPRequest(args, headers)).then((res) => {
      return buildResponse(res).then(_data => {
        return {
          payments: <Array<Payment>>(_data.payments)
