...
export class API {
  ...
  createSalaryPayments = (args, headers) => {
    return this.fetch(
  ...
  getSalaryPaymentByTxnHash = (args, headers) => {
    return this.fetch(
      ...
      return buildResponse(res).then(_data => {
        return {
          payment: new Payment(_data.payment)
        }
      })
    })
  }
  
  getOrgMemberSalaryPaymentsHistory = (args, headers) => {
    return this.fetch(
  ...
  getMemberOverallSalaryHistory = (args, headers) => {
    return this.fetch(
